...
class DistilBERTClass(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.dropout = torch.nn.Dropout(0.3)
         ...
         # Final classifier layer 4 output classes
...
def input_fn(request_body, request_content_type):  # Process incoming request data
...
def output_fn(prediction, accept):  # Format the output based on accept header
